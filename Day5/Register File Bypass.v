...
\TLV
   ...
   |cpu
      @0
         ...
         $start = >>1$reset && !$reset;// Should be asserted immediately when reset is desserted and was high in previous cycle
         
         $valid = $reset ? 1'b0 : 
                  $start ? 1'b1 :
                  >>3$valid; // Should get asserted when valid goes high
      @1
